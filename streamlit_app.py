...
if ('green' in matching_colours_list):
	st.text('yes: ' + str(matching_colours_list[np.where(matching_colours_list == 'red')[0],1:]))
	st.text('yes: ' + str(np.where(matching_colours_list == 'red')[0]))
